...
n_2017 %>%
  ...
  labs(x = "Año", y = "% de muertes maternas",title="Comportamiento de la Mortalidad Materna en México por Entidad Federativa",
...
youtube_intervals %>%
  ...
  labs(x = "Estimaciones", y = "Muestras",title="Intervalos de Confianza de la Mortalidad Materna en México por \nEntidad Federativa",
